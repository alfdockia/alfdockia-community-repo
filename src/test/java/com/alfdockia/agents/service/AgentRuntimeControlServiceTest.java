...
import com.alfdockia.agents.service.secrets.SecretsService;
...
public class AgentRuntimeControlServiceTest {
    ...
    public void setUp() {
        ...
        service.setLicenseEnforcement(mock(com.alfdockia.agents.service.license.LicenseRuntimeEnforcementService.class));
    ...
    public void licenseBlocksStartBeforeDockerOrRegistryMutation() {
        com.alfdockia.agents.service.license.LicenseRuntimeEnforcementService enforcement =
                mock(com.alfdockia.agents.service.license.LicenseRuntimeEnforcementService.class);
        service.setLicenseEnforcement(enforcement);
        org.mockito.Mockito.doThrow(new com.alfdockia.agents.service.exception.BadRequestException(
        ...
        catch (com.alfdockia.agents.service.exception.BadRequestException expected) { }
