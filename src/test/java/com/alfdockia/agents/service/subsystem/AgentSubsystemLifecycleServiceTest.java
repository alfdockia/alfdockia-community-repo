 ...
 */
package com.alfdockia.agents.service.subsystem;
...
public class AgentSubsystemLifecycleServiceTest {
    ...
    public void setUp() {
        ...
        lifecycleService.setLicenseEnforcement(mock(com.alfdockia.agents.service.license.LicenseRuntimeEnforcementService.class));
    ...
    public void startupDoesNotStartExcessContainers() {
        ...
        doThrow(new com.alfdockia.agents.service.exception.BadRequestException(
