package com.alfdockia.agents.service.registry.impl;
...
public class AgentRegistryStartupTest {
    ...
    private static QName agentProperty(String name) { return QName.createQName("http://www.com/model/alfdockia/1.0", name); }
